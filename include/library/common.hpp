...
#define _ATOM_CONCAT(x, y) x##y
#define _ATOM_STRINGIFY(x) #x
#define ATOM_CONCAT(x, y) _ATOM_CONCAT(x, y)
#define ATOM_STRINGIFY(x) _ATOM_STRINGIFY(x)
#define ATOM_ANONYMOUS_VAR(x) ATOM_CONCAT(x, __LINE__)
